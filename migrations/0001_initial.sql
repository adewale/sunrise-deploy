...
CREATE TABLE IF NOT EXISTS action_items (id TEXT PRIMARY KEY, canonical_subject_key TEXT NOT NULL UNIQUE, priority TEXT NOT NULL, kind TEXT NOT NULL, title TEXT NOT NULL, repo TEXT NOT NULL, url TEXT NOT NULL, updated_at TEXT NOT NULL, reason TEXT NOT NULL, suggested_action TEXT NOT NULL, evidence_json TEXT, source TEXT NOT NULL, ignored_at TEXT);
...
CREATE INDEX IF NOT EXISTS idx_action_items_priority_updated ON action_items(priority, updated_at DESC);
